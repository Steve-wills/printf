...
va_list lists, char buffer[], int flags, int width, int acc, int size);
...
int print_hexa(va_list arglist, char map_to[],
char buffer[], int flags, char flag_ch, int width, int acc, int size);
...
int write_number(int is_positive, int ind, char buffer[],
	int flags, int width, int acc, int size);
int write_num(int ind, char bff[], int flags, int width, int acc,
